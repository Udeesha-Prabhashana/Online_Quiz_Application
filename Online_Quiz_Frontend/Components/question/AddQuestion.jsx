...
const AddQuestion = () => {
    ...
    const handleAddSubject = () => {
		if (newSubject.trim() !== "") {                  //trim() method in JavaScript is a built-in method for strings that removes whitespace from both ends of a string
                            ...
                            <form onSubmit={handleSubmit} className="p-2">
                                ...
                                <div className="mb-3">
                                    ...
                                    <select
                                        id='question-type'
                                        value={questionType}
                                        onChange={(e) => setQestionType(e.target.value)}
                                        className='form-control'
                                    >
                                ...
                                {questionType === "multiple" && (
                                    <div className="mb-3">                        
                                        <label htmlFor="answers" className='form-label text-info'>
                                            Correct Answer(s)
                                        </label>
